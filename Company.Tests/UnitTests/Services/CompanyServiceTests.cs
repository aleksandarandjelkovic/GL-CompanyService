...
using Company.Tests.Common;
using FluentAssertions;
using Moq;

namespace Company.Tests.UnitTests.Services
{
    public class CompanyServiceTests
    {
        ...
        public async Task GetAllCompaniesAsync_ShouldReturnAllCompanies()
        {
            ...
            {
                TestUtils.CreateTestCompany("Company 1", "TKR1", "NYSE", "US0000000001"),
                TestUtils.CreateTestCompany("Company 2", "TKR2", "NASDAQ", "US0000000002"),
                TestUtils.CreateTestCompany("Company 3", "TKR3", "LSE", "GB0000000003")
            };
        ...
        public async Task GetCompanyByIdAsync_ShouldReturnCorrectCompanyDTO()
        {
            ...
            var company = TestUtils.CreateTestCompany(
                "Test Company",
                "TEST",
                "NYSE",
                "US1234567890",
        ...
        public async Task GetCompanyByIsinAsync_ShouldReturnCorrectCompany()
        {
            ...
            var company = TestUtils.CreateTestCompany("Test Company", "TEST", "NYSE", isin);
        ...
        public async Task GetCompanyByIsinAsync_ShouldNormalizeIsin()
        {
            ...
            var company = TestUtils.CreateTestCompany("Test Company", "TEST", "NYSE", normalizedIsin);
        ...
        [Fact]
        public async Task CreateCompanyAsync_ShouldAddCompanyAndReturnGuid()
        {
            // Arrange
        ...
        public async Task CreateCompanyAsync_WithInvalidISINFormat_ShouldReturnFailure()
        {
            ...
            var companyRequest = new CreateCompanyRequest
            {
                ...
                Ticker = "TEST",
                Exchange = "NYSE",
                ISIN = "123456789012", // Invalid ISIN - doesn't start with 2 letters
                Website = "https://test-company.com"
            };
            ...
            result.Error.Should().Contain("ISIN");

            // Verify the repository methods were never called
        ...
        public async Task UpdateCompanyAsync_ShouldUpdateAndReturnCompany()
        {
            // Arrange
            var companyId = Guid.NewGuid();
            var existingCompany = TestUtils.CreateTestCompany(
                "Original Company", 
                "ORIG", 
                "NYSE", 
                "US1234567890", 
            ...
            result.Value.ISIN.Should().Be(updateRequest.ISIN);
        ...
        public async Task UpdateCompanyAsync_WithNonExistentId_ShouldThrowEntityNotFoundException()
        {
            ...
            _mockRepository.Setup(repo => repo.GetByIdAsync(updateRequest.Id))
                .ReturnsAsync((Domain.Entities.Company)null!);
            ...
            // Verify repository calls
            _mockRepository.Verify(repo => repo.GetByIdAsync(updateRequest.Id), Times.Once);
        ...
        public async Task UpdateCompanyAsync_WithDuplicateISIN_ShouldThrowBusinessRuleException()
        {
            ...
            var updateRequest = new UpdateCompanyRequest
            {
                ...
                Ticker = "UPDT",
                Exchange = "NASDAQ",
                ISIN = "US9876543210", // Different ISIN than existing
                Website = "https://updated-company.com"
            };
            ...
            // Setup ISIN to not be unique (already used by another entity)
            _mockRepository.Setup(repo => repo.IsIsinUniqueAsync(updateRequest.ISIN))
                .ReturnsAsync(false);
